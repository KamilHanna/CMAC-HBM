...
`include "dma5_defines.svh"
    ...
    typedef enum mdma_glbl_csr_addr_t {
        ...
        MDMA_GLBL_CRDT_COAL_IDLE_CNT_A0,
        MDMA_GLBL_CRDT_COAL_IDLE_CNT_A1,
        MDMA_GLBL_CRDT_COAL_BUSY_CNT_A0,
        MDMA_GLBL_CRDT_COAL_BUSY_CNT_A1,
        MDMA_GLBL_CRDT_COAL_ACTV_CNT_A0,
        MDMA_GLBL_CRDT_COAL_ACTV_CNT_A1,
        MDMA_GLBL_PFCH_EVT_ACTV_CNT_A0,
        MDMA_GLBL_PFCH_EVT_ACTV_CNT_A1,
        MDMA_GLBL_M_AXIS_RQ_PKT_CNT_A0,
        MDMA_GLBL_M_AXIS_RQ_PKT_CNT_A1,
        MDMA_GLBL_M_AXIS_RQ_IDLE_CNT_A0,
        MDMA_GLBL_M_AXIS_RQ_IDLE_CNT_A1,
        MDMA_GLBL_M_AXIS_RQ_BUSY_CNT_A0,
        MDMA_GLBL_M_AXIS_RQ_BUSY_CNT_A1,
        MDMA_GLBL_M_AXIS_RQ_ACTV_CNT_A0,
        MDMA_GLBL_M_AXIS_RQ_ACTV_CNT_A1,
        MDMA_GLBL_C2H_WAIT_DESC_ACTV_CNT_A0,
        MDMA_GLBL_C2H_WAIT_DESC_ACTV_CNT_A1
   ...
   typedef struct packed {
    ...
    typedef struct packed {
        logic [12:0]    rsv;
        logic           dis_fence_fix;  // Disable the performance fix on the eviction fence
